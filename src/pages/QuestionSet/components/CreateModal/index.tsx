...
function CreateQuestionSetModal({
  ...
  const onSubmit = async (data: FormData) => {
    try {
      ...
      // API call
      const res = await fetch("https://exslhvvumjuuypkyiwwm.supabase.co/functions/v1/question-set", {
        method: "POST",
        headers: {
    ...
    >
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="grid gap-4">
          ...
          {/* Question Vietnamese */}
          <div className="grid w-full gap-3">
            <Label htmlFor="name_vi">Tên bộ bài (Tiếng Việt)</Label>
            <Controller
              name="name_vi"
              control={control}
