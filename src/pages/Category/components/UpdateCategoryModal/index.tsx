...
function UpdateCategoryModal({
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      // API call
      const res = await fetch(`https://exslhvvumjuuypkyiwwm.supabase.co/functions/v1/category?id=${category.id}`, {
        method: "PUT",
        headers: {
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="grid gap-4">
          ...
          <div className="grid w-full gap-3">
            <Label htmlFor="name_en">Tên danh mục (Tiếng Anh)</Label>
            <Controller
              name="name_en"
              control={control}
          ...
          {/* Question Vietnamese */}
          <div className="grid w-full gap-3">
            <Label htmlFor="question_vi">Tên danh mục (Tiếng Việt)</Label>
            <Controller
              name="name_vi"
              control={control}
